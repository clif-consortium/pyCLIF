...
class Med_admin_con:
    ...
    def get_duckdb_register(self):
        try:
            duckdb.unregister("med_admin_con")
        except:
            pass
        finally:
            duckdb.register("med_admin_con", self.df)
    
    def load_json(self):
        with open('pyCLIF/mCIDE/Med_admin_con.json', 'r') as file:
            data = json.load(file)  
        return data
    ...
    def load_data(self):
        ...
        Returns:
            pd.DataFrame: DataFrame containing Med_admin_con data.
        """
